          ...
          <SidebarGroup className="p-0 mt-4">
            <CollapsibleTrigger
              render={
                <button
                  type="button"
                  className="text-sidebar-foreground/70 ring-sidebar-ring rounded-md px-2 font-medium transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 shrink-0 outline-hidden [&>svg]:shrink-0 h-4 pb-4 pt-2 text-[10px] uppercase tracking-widest text-muted-foreground hover:text-foreground hover:bg-transparent cursor-pointer flex items-center justify-between w-full"
                >
                  ...
                  <span className="inline-flex size-5 items-center justify-center rounded-md hover:bg-muted">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            render={
              <button
                type="button"
                className="flex w-full items-center gap-3 p-2 rounded-lg cursor-pointer hover:bg-accent transition-colors mt-2 text-left"
              >
